...
public class SobrepesoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intent != null) {
            ...
            textViewClassificacao.setText(getString(R.string.label_classificacao_sobrepeso));

            // Definindo mensagem motivacional
            textViewMensagem.setText(R.string.mensagem_sobrepeso);

            // Definindo imagem relevante para a categoria
            imageViewFeedback.setImageResource(R.drawable.sobrepeso);
        }
