...
public class Obesidade2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_obesidade_2);
        ...
        if (intent != null) {
            ...
            textViewClassificacao.setText(getString(R.string.label_classificacao_obesidade_2));

            // Definindo mensagem motivacional
            textViewMensagem.setText(R.string.mensagem_obesidade_2);

            // Definindo imagem relevante para a categoria
            imageViewFeedback.setImageResource(R.drawable.obesidade_2);
        }
