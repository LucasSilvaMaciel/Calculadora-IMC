...
public class PesoNormalActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intent != null) {
            ...
            textViewClassificacao.setText(getString(R.string.label_classificacao_peso_normal));

            // Definindo mensagem motivacional
            textViewMensagem.setText(R.string.mensagem_peso_normal);

            // Definindo imagem relevante para a categoria
            imageViewFeedback.setImageResource(R.drawable.peso_normal);
        }
