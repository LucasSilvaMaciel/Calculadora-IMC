...
public class Obesidade1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intent != null) {
            ...
            textViewClassificacao.setText(getString(R.string.label_classificacao_obesidade_1));

            // Definindo mensagem motivacional
            textViewMensagem.setText(R.string.mensagem_obesidade_1);

            // Definindo imagem relevante para a categoria
            imageViewFeedback.setImageResource(R.drawable.obesidade_1);
        }
